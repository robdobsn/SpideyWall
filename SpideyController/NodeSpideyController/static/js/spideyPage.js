...
(function() {
  var deleteScript, editScript, getAllSnippets, initSpidey, loadSpideyGeom, random, rgbColour, selectScript, show, showScriptList, showSpideyLeds, spideyCloseScript, spideyDrawFunction, spideyNewScript, spideyRunScript, spideySaveScript, spideyShowScript, spideyStopScript;
  ...
  loadSpideyGeom = function() {
    ...
    return jqXHR = $.getJSON("/SpideyGeometry.json", function(data) {
      ...
      window.LEDS.closest = function(pt) {
      ...
      return window.PADS = window.spideyGeom.pads;
    });
  };
